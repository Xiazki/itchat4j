...
import mobi.mixiong.wx.http.MXHttpClient;
import mobi.mixiong.wx.util.RequestUrlBuilder;
import mobi.mixiong.wx.util.enums.RequestEnum;
import mobi.mixiong.wx.util.enums.ResultEnum;
import mobi.mixiong.wx.util.enums.ResultTools;
...
public class DefaultLifecycleProcessor implements LifecycleProcessor {
    ...
    public static void main(String[] args) {
        String[] retParams = "a=asde123123 ;b=\"1233==sd123\"".split(";");
